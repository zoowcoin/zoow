...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 ZOW from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 ZOW in block rewards plus fees, but
        ...
        # Send 100 ZOW with subtract fee from amount
        ...
        # Sendmany 100 ZOW with subtract fee from amount
