# Linearize
Construct a linear, no-fork, best version of the ZOOW blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install zoow_hash

https://github.com/zoowpay/zoow_hash
...
JSON-RPC server. Running `zoowd` or `zoow-qt -server` will be sufficient.
...
* `input`: zoowd blocks/ directory containing blkNNNNN.dat
