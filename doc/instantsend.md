...
This mechanism has been integrated into Bitcore-Node-ZOOW which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/zoowpay/insight-api-zoow#web-socket-api](https://github.com/zoowpay/insight-api-zoow#web-socket-api)
* API: [https://github.com/zoowpay/insight-api-zoow#instantsend-transactions](https://github.com/zoowpay/insight-api-zoow#instantsend-transactions)
...
By default, the ZOOW Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ZOOW Core daemon:
