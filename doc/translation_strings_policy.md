...
This document provides guidelines for internationalization of the ZOOW Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `zoow_en.ts` remains unchanged.
