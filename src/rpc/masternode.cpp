...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print ZOOW address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "zoow",               "masternode",             &masternode,             true,  {} },
    { "zoow",               "masternodelist",         &masternodelist,         true,  {} },
    { "zoow",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "zoow",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "zoow",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "zoow",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
