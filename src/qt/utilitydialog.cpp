    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  zoow-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the ZOOW in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ZOW, 0.1 ZOW, 1 ZOW and 10 ZOW -- sort of like the paper money you use every day.</li> \
