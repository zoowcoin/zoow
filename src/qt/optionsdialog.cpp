    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ZOW-light"), QVariant("light"));
    ui->theme->addItem(QString("ZOW-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("ZOW-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("ZOW-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("ZOW-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ZOW-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ZOW-traditional"), QVariant("trad"));
